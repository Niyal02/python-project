...
scheduled = {'KTM': ["10:10", 'PKH', "Delayed"], 'Nepal': ['5:30', 'Quatar', 'Delayed'],
             'India': ['1:49', 'Bangladesh', 'Scheduled'], 'USA': ['7:40', 'Australia', 'Scheduled']
            }
cancelled = {'Ghana': ["3:00", "New York", "Cancelled"]}
